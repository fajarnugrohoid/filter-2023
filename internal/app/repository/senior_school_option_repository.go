...
func NewSeniorSchoolOptionRepository(db *mongo.Database) *SeniorSchoolOptionRepository {
	return &SeniorSchoolOptionRepository{db}
}

func (sr SeniorSchoolOptionRepository) GetSeniorSchoolOptionByOptType(ctx context.Context, level string, optType string) []*domain.PpdbOption {
	//TODO implement me
